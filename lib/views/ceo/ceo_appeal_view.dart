...
class _CeoAppealViewState extends State<CeoAppealView> {
  ...
  void initState() {
    super.initState();
    // Clear any previous appeal state when the view is opened
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted) {
        Provider.of<CeoViewModel>(context, listen: false).clearAppealState();
      }
    });
  }
            ...
            child: ListView(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  validator: (v) => (v == null || v.trim().length < 50) ? 'Please enter at least 50 characters' : null,
                ),
                ...
                if (viewModel.errorMessage != null) ...[
                  ...
                  Text(
                    ...
                    style: const TextStyle(color: CeoColors.red, fontSize: 14, fontWeight: FontWeight.w500),
                  ),
                ],
                const SizedBox(height: 48),
                ElevatedButton(
                  onPressed: viewModel.isLoading ? null : () async {
                    developer.log('[UI] CEO Appeal: Submit button pressed');
                    if (_formKey.currentState!.validate()) {
                      developer.log('[UI] CEO Appeal: Validation passed');
