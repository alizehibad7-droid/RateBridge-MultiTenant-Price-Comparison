...
Future<void> showSupplierChangePasswordSheet(
  ...
  return showModalBottomSheet<void>(
    ...
    builder: (context) => Padding(
      ...
      child: SupplierChangePasswordSheet(email: email),
    ),
  );
}

class SupplierChangePasswordSheet extends StatefulWidget {
  final String email;

  const SupplierChangePasswordSheet({super.key, required this.email});

  @override
  State<SupplierChangePasswordSheet> createState() =>
      _SupplierChangePasswordSheetState();
}

class _SupplierChangePasswordSheetState
    extends State<SupplierChangePasswordSheet> {
