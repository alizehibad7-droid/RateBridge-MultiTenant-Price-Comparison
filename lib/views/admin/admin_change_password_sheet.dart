...
Future<void> showAdminChangePasswordSheet(
  ...
  return showModalBottomSheet<void>(
    ...
    builder: (context) => Padding(
      ...
      child: AdminChangePasswordSheet(email: email),
    ),
  );
}

class AdminChangePasswordSheet extends StatefulWidget {
  final String email;

  const AdminChangePasswordSheet({super.key, required this.email});

  @override
  State<AdminChangePasswordSheet> createState() =>
      _AdminChangePasswordSheetState();
}

class _AdminChangePasswordSheetState extends State<AdminChangePasswordSheet> {
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(widget.email, style: AdminTheme.mutedStyle()),
