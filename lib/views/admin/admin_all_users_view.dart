...
class _UserMobileCard extends StatelessWidget {
  ...
  const _UserMobileCard({required this.user, required this.onTap});
              ...
              Row(
                children: [
                  CircleAvatar(
                    ...
                    backgroundColor: AdminColors.navy.withValues(alpha: 0.1),
                    child: Text(user.name.isNotEmpty ? user.name[0].toUpperCase() : '?', 
                      style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: AdminColors.navy)),
                  ),
                  const SizedBox(width: 12),
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(user.name, style: GoogleFonts.plusJakartaSans(fontWeight: FontWeight.w700, color: AdminColors.navy, fontSize: 15)),
                        Text(user.email, style: AdminTheme.mutedStyle(size: 12)),
                      ],
                    ),
                  ),
              ...
              Row(
                ...
                children: [
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Role', style: AdminTheme.mutedStyle(size: 11)),
                      Text(user.role.toUpperCase(), style: AdminTheme.bodyStyle(weight: FontWeight.bold)),
                    ],
                  ),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.end,
                    children: [
                      Text('Joined', style: AdminTheme.mutedStyle(size: 11)),
                      Text(DateFormat('MMM d, yyyy').format(user.createdAt), style: AdminTheme.bodyStyle()),
                    ],
                  ),
                ],
              ),
